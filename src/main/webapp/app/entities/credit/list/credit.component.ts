...
export class CreditComponent implements OnInit {
  ...
  trackId = (_index: number, item: ICredit): number => this.creditService.getCreditIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.credits = this.refineData(dataFromBody);
  }

  protected refineData(data: ICredit[]): ICredit[] {
